...
class LinkedListIndexedCollectionTest {
    private LinkedListIndexedCollection<String> list = null;
    ...
    void constructorInitCollectionCopyElems() {
        LinkedListIndexedCollection<String> tmp = new LinkedListIndexedCollection<>(this.list);
    ...
    void containsOtherType() {
        assertFalse(this.list.contains(123));
    }
}
